...
const Sidebar = ({ check }: any) => {
  ...
  return (
    <>
      ...
      <div className={`w-full sm:hidden h-16 flex items-center justify-center  fixed bottom-0 bg-white shadow-lg z-50 ${pathname==`/view-community/${params.id}` || pathname==`/chats/${params.chatId}` ? 'hidden' : 'flex'}`}>
